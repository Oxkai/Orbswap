...
bash scripts/deploy_demo.sh      # full demo: factory+router, both live pools (shared USDC), 18 swaps
```
...
Network passphrase: `Test SDF Network ; September 2015`. Deployed by
[`deploy_demo.sh`](scripts/deploy_demo.sh); source of truth
[`deployments/testnet_demo.json`](deployments/testnet_demo.json). **USDC is shared** across both
pools, so EURC / USDM / BRLT ↔ NGNC route multi-hop through it.

**SuperElliptical pool** — USDC / EURC / USDM / BRLT, 24M TVL (6M each), 30 bps.

| Contract | Address |
|---|---|
| **Pool** | [`CDGR7RRE72JKAW5UATPKCANAPVX3YVLPDEKSPNPVZ5BKLI43VAUC2RWK`](https://stellar.expert/explorer/testnet/contract/CDGR7RRE72JKAW5UATPKCANAPVX3YVLPDEKSPNPVZ5BKLI43VAUC2RWK) |
| USDC | `CBNDCO3DMKFVCSVFPHMYK6KSD6CCKVUMI3TFK6ZJ3BP7NCNLUJBJAB6Z` |
| EURC | `CAXVONHQX5SHHTEG2AQYSE4YO6CSSRIOGA3MTCTDL3ZS5K2HVWFGEHID` |
| USDM | `CB6MC6LXWCOGEDPOTJIQHTE6VZF46RWVGWJJE6D52SS4P2FTJSBEJBMN` |
| BRLT | `CAD3IHN2D7LYAVAIUMTS5KAWCT6ACXPTV2LAQNVO6Q77WDP3XLY2BGG7` |

**Circular concentrated-liquidity (tick) pool** — USDC / NGNC, 5M TVL, 30 bps. Full-range +
concentrated `[40,50]` positions, tick-walk swap, per-tick fees.

| Contract | Address |
|---|---|
| **Tick pool** | [`CATAWBZMD337WXYZ3R5CX7KNFCBDLI7TAMDU6XSSPRDBLMZXWIGQ37HC`](https://stellar.expert/explorer/testnet/contract/CATAWBZMD337WXYZ3R5CX7KNFCBDLI7TAMDU6XSSPRDBLMZXWIGQ37HC) |
| USDC | `CBNDCO3DMKFVCSVFPHMYK6KSD6CCKVUMI3TFK6ZJ3BP7NCNLUJBJAB6Z` (shared) |
| NGNC | `CCUC4GORGIR4MPKFORGHT37HJRCDERYHN3J34DQ4E5XK37JIL3H5EKYL` |

**Periphery + accounts.**

| Role | Address |
|---|---|
| **Factory** | [`CCKK33NWDQPSONMRAWH2FNF2ZRZ4VR3PLUP73FUHZGOEMUH665WD5TJW`](https://stellar.expert/explorer/testnet/contract/CCKK33NWDQPSONMRAWH2FNF2ZRZ4VR3PLUP73FUHZGOEMUH665WD5TJW) |
| **Router** | [`CCARGBIGZFOUIOSVM4Q5RNDOIJISYOFSL2VHVYPYWIZP67IV6FHGAVLJ`](https://stellar.expert/explorer/testnet/contract/CCARGBIGZFOUIOSVM4Q5RNDOIJISYOFSL2VHVYPYWIZP67IV6FHGAVLJ) |
