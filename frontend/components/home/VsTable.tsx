...
const COLUMNS = ["Uniswap V3", "Curve Stable", "Balancer", "Orbswap"] as const;
...
const ROWS: Row[] = [
  ...
  },
  {
    ...
    values: ["High (pair)", "~1–2× flat", "~1–2× flat", "~100× flat"],
    highlights: [false, false, false, true],
  },
  {
    property: "Price oracle",
    values: ["Yes", "No", "Yes", "Spot"],
    highlights: [true, false, true, true],
  },
  {
    property: "LP position type",
    values: ["NFT (721)", "LP token", "LP token", "Shares"],
    highlights: [false, false, false, true],
  },
  {
    property: "Venue",
    values: ["Standalone", "Standalone", "Standalone", "Soroban / Stellar"],
    highlights: [false, false, false, true],
  },
];
          ...
          >
            ...
            {COLUMNS.map((c, ci) => (
              <div
                ...
                style={{ fontFamily: "var(--font-mono)", fontSize: "11px", letterSpacing: "0.06em", color: c === "Orbswap" ? colors.purple.hex : color.textSecondary, textTransform: "uppercase" }}
              >
                {c}
              </div>
            ))}
          ...
          {ROWS.map((row, ri) => (
            ...
            >
              ...
              {COLUMNS.map((col, vi) => (
                ...
                >
                  <span style={{ fontFamily: "var(--font-mono)", fontSize: "10px", letterSpacing: "0.06em", color: col === "Orbswap" ? colors.purple.hex : color.textMuted, textTransform: "uppercase" }}>
                    {col}
                  </span>
                  <span style={{
                    fontFamily: vi === 3 ? "var(--font-mono)" : typography.p2.family,
