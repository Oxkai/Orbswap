...
const REFS = [
  {
    n: "01",
    authors: "Tolstikov, Wentz, Schiarizzi",
    title: "Orbswap: Concentrated N-dimensional AMM with Polar Coordinates in Rust",
    year: "2025",
    href: "/orbswap-paper.pdf",
  },
  {
    n: "02",
    authors: "Paradigm",
...
export function References() {
  return (
    <section className="mx-6 my-1">
      <SectionLabel border chapter="VIII" section="07" path="ORBSWAP / REFERENCES" />
